...
function patchMainProcess(platform) {
  ...
  const startupHomeInitialization = [
    ...
    "let authPath=o.join(t,`" + homeInitialization.authFileName + "`),configPath=o.join(t,`" + homeInitialization.configFileName + "`),seedConfigPath=o.join(seedRoot,`" + homeInitialization.configFileName + "`);",
    "c.existsSync(authPath)||!c.existsSync(o.join(seedRoot,`" + homeInitialization.authFileName + "`))||c.copyFileSync(o.join(seedRoot,`" + homeInitialization.authFileName + "`),authPath);",
